...
void PrivmsgCommand::execute(Client* client, const Message& message)
{
	...
	Print::Debug("PRIVMSG: '" + client->getNickname() + "' -> '" + target + "': '" + messageText + "'");
...
void PrivmsgCommand::handleChannelMessage(Client* sender, const std::string& channelName, const std::string& message)
{
...
void PrivmsgCommand::handlePrivateMessage(Client* sender, const std::string& targetNick, const std::string& message)
{
...
std::string PrivmsgCommand::createMessage(Client* sender, const std::string& command, const std::string& target, const std::string& message)
{
