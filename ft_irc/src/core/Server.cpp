...
void Server::stop()
{
	Print::StdOut("Starting server shutdown process...");
	_running = false;
...
void Server::processNewConnection()
{
	...
	{
		Print::StdErr("Error accepting connection: " + _serverSocket.getLastError());
		return;
	}

	Print::Debug("Socket accepted successfully");
	...
	Print::StdOut("New connection accepted. FD: " + toString(clientFd));
}
